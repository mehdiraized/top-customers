...
import LocaleSwitcher from "@/components/LocaleSwitcher/LocaleSwitcher.component";
import ListUsers from "@/components/ListUsers/ListUsers.component";

import { usersGet } from "@/infrastructure/api/User/users.api";
...
export default async function Home() {
	...
	const t = await getTranslations("errors.users");
	...
	return (
		<main className="flex min-h-screen flex-col items-center justify-around p-24">
			...
			<div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left items-center gap-6">
				...
				<ListUsers
					users={users}
					errors={{ title: t("fetch"), buttonLabel: t("fetchAgain") }}
				/>
			</div>
		</main>
	);
